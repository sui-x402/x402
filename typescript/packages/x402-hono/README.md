...
Hono middleware integration for the x402 Payment Protocol. This is a Sui-supported fork of Coinbase x402 Payment Protocol. This package allows you to easily add paywall functionality to your Hono applications using the x402 protocol.
...
import { paymentMiddleware, Network } from "@nautic/x402-hono";
